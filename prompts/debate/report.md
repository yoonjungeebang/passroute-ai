...
- strengths: 세션에서 일관되게 잘한 점 1~2문장. "논리적이에요" 같은 추상적 칭찬 금지.
- weaknesses: logic·rebuttal_quality·consistency·attitude 중 부족한 항목 기준.
  1~3개 항목 (가장 약한 영역부터 우선). 모든 점수가 4.0 이상이면 빈 배열 [].
  comment는 왜 약점인지 1문장으로 구체적으로 서술.
- improvements: 구체적 행동 방향 1~2문장. "더 노력하세요" 같은 추상적 표현 금지.
- turn_feedback: 각 라운드에 대해 점수 나열이 아닌 인사이트 중심 1~2문장.
  round_type과 weighted_score는 입력 데이터에서 그대로 복사.
